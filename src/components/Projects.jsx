 ...
 function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      link: 'https://www.techvibesbitj.in/',
      status: 'live',
    ...
    },
    {
      ...
      link: 'https://kanbanboard-roan.vercel.app/',
      status: 'completed',
    ...
    },
    {
      ...
      link: 'https://drive.google.com/drive/folders/13dDAKWoIeXlYifJZBaPm_7oICd2UxDAM?usp=drive_link',
      status: 'completed',
